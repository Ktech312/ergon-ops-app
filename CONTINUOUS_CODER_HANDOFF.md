...
**Manual-action queue, current exact state: EMPTY.** Migrations 155, 156, 157, 158, and 159 are all
confirmed applied and their canonical tests all passed in production, 2026-09-17. Stage 3's RLS half
(migration 160) scoping is next.
